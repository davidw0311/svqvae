...
if __name__ == '__main__':
    ...
    # model_checkpoint = 'checkpoints/train-svqvae-withmask-wbc_1-1024_023602/checkpoints/svqvae_best_95.pt'
    # model_checkpoint = 'checkpoints/train-svqvae-withmask-wbc_10-1024_032703/checkpoints/svqvae_best_61.pt'
    model_checkpoint = 'checkpoints/train-svqvae-withmask-wbc_50-1024_033037/checkpoints/svqvae_best_34.pt'
    ...
    for name in losses:
        ...
        plt.savefig(f"output/finetune-mask-{ds.replace(' ','-')}-{name}.png") 
